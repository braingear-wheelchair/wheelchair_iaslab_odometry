...
int main(int argc, char** argv){
  ros::init(argc, argv, "odometry_old_publisher");

  ros::NodeHandle nh;



  ros::Publisher odom_pub = nh.advertise<nav_msgs::Odometry>("odom_old", 50);
...
*/
    ...
    odom_trans.header.frame_id = "odom_old";
